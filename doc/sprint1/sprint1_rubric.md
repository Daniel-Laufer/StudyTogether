...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 2 (no link provided to support the diagram since you aren't using MVC)
...
2/2
Create a group page could use some margins on the side
...
Amazing work! Excited to see what you folks do in the next few sprints. 
