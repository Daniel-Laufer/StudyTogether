...
## Sprint Demo (Max 12 marks) 
  ...
  font in the study group module is pretty jarring compared to rest of the site

  the register/leave button in the additional study group info page should be centered

  "Additional" is spelled wrong
